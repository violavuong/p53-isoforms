...
# custom function 
source("C:/Users/Dell/Desktop/git_projects/TP53/fun/utils.R")

# global inputs
wd <- "C:/Users/Dell/Alma Mater Studiorum Università di Bologna/MM group - Documenti/CARTELLE_PERSONALI/Vuong_Viola_Meixian/TP53/"
setwd(wd)

# WB data
pp_tp53 <- read_xlsx("wb_tp53.xlsx", sheet = "Densitometry") 
pts <- pp_tp53$MPC
