...
# ---- Define cohort ----
mmrf_p53_tpm_per_pt <- mmrf_tpm_per_pt %>% #fread("mmrf_tpm_per_pt_ia24.txt") %>%
...
mmrf_p53_expression_cat <- mmrf_p53_presence_cat %>%
  ...
  select(public_id, starts_with("p53_FL"), starts_with("p53_beta"), starts_with("p53_gamma"), starts_with("delta_40"), 
